...
public class MyView extends View {
    ...
    String typeShape = MyView.TYPE_RECT;
    String color = "000000";
...
//        canvas.drawColor(Color.RED);
    ...
    public void undo(){
        if(counterShapes > 0){counterShapes--; this.invalidate();}
    }
...
//            this.invalidate();
            ...
            if (counterPoints < MAX_POINTS ) {
                ...
                switch (this.typeShape){
                    case TYPE_RECT: checkPointForCreateRect(); break;
    ...
    private void checkPointForCreateRect() {
        if(counterPoints >= 2){
            // Создать прямоугольник
            Rect rect = new Rect(color,points[0], points[1]);
